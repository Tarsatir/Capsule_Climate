...
function get_capgood_euclidian(model_struct, global_param)
    ...
    for i in 1:global_param.F1
        for j in i:global_param.F1
            ...
            A1 = model_struct.capital_good_producers[i].A_t[end]
            A2 = model_struct.capital_good_producers[j].A_t[end]
            B1 = model_struct.capital_good_producers[i].B_t[end]
            B2 = model_struct.capital_good_producers[j].B_t[end]
